 ...
 * @return The lesser of the two specified numbers
 */
 ...
 * @param {number} n Number
 * @param {number} m Number
 * @return The bigger of the two specified numbers
 */
 ...
 * @return The specified number raised to the specified power
 */
 ...
 * @return The angle whose tangent is the quotient of the two specified values
 */
 ...
 * @function
 * @return Pseudo-random number between 0 (inclusive) and 1 (exclusive)
 */
JustMath.random = Math.random;

/**
 * Constructs a new Vec2.
 * @exports dcodeIO.JustMath.Vec2
...
/**
 * Clones this Vec2.
 * @return {dcodeIO.JustMath.Vec2} Cloned Vec2
 */
...
/**
 * Copies this Vec2.
 * @return {dcodeIO.JustMath.Vec2} Copied Vec2
 * @see Alias of {@link dcodeIO.JustMath.Vec2#clone}
 */
 ...
 * @param {number=} y Y coordinate if vOrX is X coordinate
 * @return {dcodeIO.JustMath.Vec2} This Vec2
 */
 ...
 * @param {dcodeIO.JustMath.Vec2} b Other Vec2
 ...
 * This operation requires a call to {@link dcodeIO.JustMath.sqrt}.
 * @param {dcodeIO.JustMath.Vec2} b Other Vec2
 ...
 * This operation requires a call to {@link dcodeIO.JustMath.atan2}.
 ...
 * This operation requires a call to {@link dcodeIO.JustMath.sin} and {@link dcodeIO.JustMath.cos}.
 ...
 * @param {dcodeIO.JustMath.Vec2} n Vector to reflect from
 * @return {dcodeIO.JustMath.Vec2} This Vec2
 */
 ...
 * @param {dcodeIO.JustMath.Vec2} p1
 * @param {dcodeIO.JustMath.Vec2} p2
 ...
 * @param {dcodeIO.JustMath.Vec2} v1 Vector 1
 * @param {dcodeIO.JustMath.Vec2} v2 Vector 2
 * @returns {number} Determinant of the matrix [v1,v2]
 */
...
if (typeof module != 'undefined' && module["exports"]) {
    ...
    define("dcodeIO/JustMath/JustMath", [], function() { return JustMath; });
} else if (typeof window != "undefined") {
    if (typeof window["dcodeIO"] == "undefined") {
        window["dcodeIO"] = {};
    }
    window["dcodeIO"]["JustMath"] = JustMath;
    delete window["Vec2"];
    delete window["JustMath"];
}